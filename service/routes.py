...
def update_accounts(account_id):
    ...
    and the data in the body that is posted.
    """
...
def delete_accounts(account_id):
    ...
    account = Account.find(account_id)
    if account: # Only attempt to delete if the account exists
        account.delete()
        app.logger.info("Account with ID [%s] deleted.", account_id)
    else:
        app.logger.info("Account with ID [%s] not found, skipping delete.", account_id)
